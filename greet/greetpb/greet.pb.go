...
type GreetManyTimesRequest struct {
	...
	Greet *GreetRequest `protobuf:"bytes,1,opt,name=greet,proto3" json:"greet,omitempty"`
}
...
func (x *GreetManyTimesRequest) GetGreet() *GreetRequest {
	if x != nil {
		return x.Greet
	}
	return nil
...
var file_greetpb_greet_proto_rawDesc = []byte{
	...
	0x74, 0x22, 0x42, 0x0a, 0x15, 0x47, 0x72, 0x65, 0x65, 0x74, 0x4d, 0x61, 0x6e, 0x79, 0x54, 0x69,
	0x6d, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x29, 0x0a, 0x05, 0x67, 0x72,
	0x65, 0x65, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x67, 0x72, 0x65, 0x65,
	0x74, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x05,
	0x67, 0x72, 0x65, 0x65, 0x74, 0x22, 0x30, 0x0a, 0x16, 0x47, 0x72, 0x65, 0x65, 0x74, 0x4d, 0x61,
	...
	0x01, 0x42, 0x0b, 0x5a, 0x09, 0x2e, 0x2f, 0x67, 0x72, 0x65, 0x65, 0x74, 0x70, 0x62, 0x62, 0x06,
...
var file_greetpb_greet_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_greetpb_greet_proto_depIdxs = []int32{
	0, // 0: greet.GreetManyTimesRequest.greet:type_name -> greet.GreetRequest
	0, // 1: greet.GreetService.Greet:input_type -> greet.GreetRequest
	2, // 2: greet.GreetService.GreetManyTimes:input_type -> greet.GreetManyTimesRequest
